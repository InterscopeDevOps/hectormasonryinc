      ...
      <div className="relative w-[85%] mx-auto h-full mt-16 md:mt-36 pt-10 pb-0 md:py-10">
        <div className="w-full h-full flex flex-col md:flex-row gap-5">
          ...
          <div className="w-full md:w-[27%] pt-3 md:pt-14 pl-0 md:pl-5">
            ...
            <div className="block bg-secondary w-1/5 h-0.5 mt-5 mb-8 mx-auto md:mx-0"></div>
            <ul>
              ...
              {dataPhone &&
                ...
                dataPhone.slice(0, 2).map((phone, index) => (
                  <li
                    key={index}
                    className="mb-5 text-gray-300 font-medium hover:text-secondary transition-all duration-300 ease-in-out"
                  >
                    <a
              ...
              {dataGlobal.services.slice(0, 6).map((service, index) => (
                <li key={index} className="mb-5">
                  <a
                    ...
                    className="text-gray-300 capitalize font-medium hover:text-secondary"
        ...
        <div className="border-t border-red-500/60 mt-10 py-5 flex flex-col md:flex-row justify-between items-center">
          {!onePages && (
